...
<html lang="en">
	...
	if(isset($_POST['login'])){
		...
		$sel="select * from librarians where Email='$email'";
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow border-0 rounded-lg mt-5">
                                    <div class="card-header bg-light"><h3 class="text-center font-weight-light my-4"><b>Library Management System <br />(Libraians)</b></h3></div>
                                    <div class="card-body">
